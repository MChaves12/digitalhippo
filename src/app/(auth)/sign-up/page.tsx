...
import { AuthCredentials, TAuthCredentials } from '@/lib/validators/account-credentials'
...
const Page = () => {
   ...
   const onSubmit = ({email, password}: TAuthCredentials) => {
    ...
    const { register, handleSubmit, formState: {errors}} = useForm<TAuthCredentials>({ resolver: zodResolver(AuthCredentials)})
